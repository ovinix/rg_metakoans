...
#
  def koan_1
    ...
    puts "Class variables: #{c.class_variables}"
    puts "Class instance variables: #{c.instance_variables}"
    puts "Class methods: #{c.methods.grep /^a[=?]?$/}"
    puts "Class instance methods: #{c.instance_methods.grep /^a[=?]?$/}"
...
#
  def koan_8
    ...
    puts "Class variables: #{c.class_variables}"
    puts "Class instance variables: #{c.instance_variables}"
    puts "Class methods: #{c.methods.grep /^[ab][=?]?$/}"
    puts "Class instance methods: #{c.instance_methods.grep /^[ab][=?]?$/}"
